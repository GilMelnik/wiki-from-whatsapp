"""Step 7: generate Hebrew wiki page drafts from aggregated claims + plan.
...
GENERATE_COMMUNITY_SYSTEM = (
    ...
    "7. ארגון: אם הטענות מתקבצות סביב נושאים, ישויות או תת-נושאים שונים — חלק את "
    "הטקסט לתת-סעיפים עם כותרות ### בלבד (לא H1/H2). אם הטענות בודדות או אחידות, "
    "השאר פרוזה רציפה ללא כותרות משנה.\n"
...
def build_community_prompt(
    ...
    return (
        ...
        'ניתן לחלק לתת-סעיפים ### לפי הצורך>",\n'
        '  "related_pages": ["<page-id>", "..."]\n'
        "}\n"
        "אם הטענות מתקבצות סביב נושאים או ישויות שונות — ארגן את גוף הטקסט בתת-סעיפים "
        "עם כותרות ###; אחרת השאר פרוזה רציפה.\n"
