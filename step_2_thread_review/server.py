...
app = make_reviewer_app("Thread Tagger")
_registry = StoreRegistry(ThreadStore, {"inspect_only": False, "threads_path": None})
...
def configure_store(
    *,
    ...
    _registry.configure(inspect_only=inspect_only, threads_path=threads_path)
